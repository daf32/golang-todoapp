...
import { CheckIcon, UserIcon, MailIcon, EyeIcon, EyeOffIcon } from '../components/Icons';
...
function AuthDeco() {
  return (
    <div className="auth-deco">
      ...
      <h1 className="auth-deco-title">Get things<br />done.</h1>
      <p className="auth-deco-sub">Start planning and organizing your tasks — all in one place.</p>
  ...
  return (
    <div className="auth-page-shell">
      ...
      <div className="auth-form-panel">
        {/* Logo mark – mobile only decoration */}
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          <div className="input-group">
            <input
              ...
              required
            />
            <span className="icon-right"><UserIcon size={16} /></span>
          </div>
        ...
        <div className="divider" style={{ margin: '24px 0' }}>or sign up with</div>
